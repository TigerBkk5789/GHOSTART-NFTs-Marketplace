...
const translations: Record<Locale, Translations> = {
  ...
  es: {
    ...
    swap: {
      ...
      description: "Intercambia entre tokens WLD y $GHOSTART",
      liveTradingTitle: "Trading en Vivo Disponible",
      liveTradingDesc: "Negocia tokens $GHOSTART en el mercado PUF con precios y liquidez en tiempo real.",
      instantSwapsTitle: "Intercambios Instantáneos",
      instantSwapsDesc: "Intercambia tokens instantáneamente con tarifas competitivas",
      secureTradingTitle: "Trading Seguro",
      secureTradingDesc: "Todos los intercambios están asegurados por contratos inteligentes",
      swapTokens: "Intercambiar Tokens",
      from: "Desde",
      to: "Hacia",
      rate: "Tasa: 1 GHOSTART = $0.000009 USDT",
      tradeOnPUF: "Negociar en Mercado PUF",
      ...
      liquidity: "Liquidez",
      tradeOnPUFTitle: "Negociar en PUF",
      tradeOnPUFDesc: "Para la mejor experiencia de trading y precios en tiempo real, usa el mercado PUF directamente.",
      backToHome: "Volver al Inicio",
      active: "Activo",
    },
    claim: {
      title: "Reclamar NFT Gratis",
      description: "Reclama tu NFT gratis de GHOSTART - ¡Sin costo requerido!",
      freeNFTTitle: "NFT Gratis Disponible",
      freeNFTDesc: "¡Reclama tu NFT exclusivo de GHOSTART completamente gratis! Limitado a 1 NFT por billetera.",
      freeMintingTitle: "Minting 100% Gratis",
      freeMintingDesc: "Sin tarifas de gas, sin pago requerido",
      onePerWalletTitle: "Uno Por Billetera",
      onePerWalletDesc: "Limitado para prevenir spam y asegurar equidad",
      earlyAccessTitle: "Beneficios de Acceso Temprano",
      earlyAccessDesc: "Obtén acceso prioritario a futuros drops y características",
      claimNFT: "Reclamar Tu NFT Gratis",
      connectWallet: "Conecta tu billetera World App",
      verifyIdentity: "Verifica tu identidad (una vez)",
      claimFree: "Reclama tu NFT gratis",
      estimatedTime: "Tiempo estimado: 30 segundos",
      agreeTerms: "Al reclamar, aceptas nuestros términos y condiciones",
      collectionInfo: "Información de la Colección NFT",
      collectionDetails: "Detalles de la Colección",
      totalSupply: "Suministro Total",
      freeClaims: "Reclamos Gratis",
      remaining: "Restantes",
      nftBenefits: "Beneficios del NFT",
      earlyAccess: "Acceso Temprano",
      priorityDrops: "Prioridad para futuros drops",
      communityAccess: "Acceso a la Comunidad",
      joinDiscord: "Únete al Discord exclusivo",
      futureRewards: "Recompensas Futuras",
      earnTokens: "Gana tokens $GHOSTART",
      viewCollection: "Ver Colección",
      viewCollectionDesc: "Revisa la colección completa de NFTs GHOSTART y ve qué otros NFTs están disponibles.",
      tradeTokens: "Intercambiar Tokens",
      backToHome: "Volver al Inicio",
  ...
  th: {
    ...
    swap: {
      title: "แลกเปลี่ยนโทเค็น",
      description: "แลกเปลี่ยนระหว่างโทเค็น WLD และ $GHOSTART",
      liveTradingTitle: "การซื้อขายสดพร้อมใช้งาน",
      liveTradingDesc: "ซื้อขายโทเค็น $GHOSTART ในตลาด PUF ด้วยราคาและสภาพคล่องแบบเรียลไทม์",
      instantSwapsTitle: "แลกเปลี่ยนทันที",
      instantSwapsDesc: "แลกเปลี่ยนโทเค็นทันทีด้วยอัตราที่แข่งขันได้",
      secureTradingTitle: "การซื้อขายที่ปลอดภัย",
      secureTradingDesc: "การแลกเปลี่ยนทั้งหมดได้รับการรักษาความปลอดภัยโดยสัญญาอัจฉริยะ",
      swapTokens: "แลกเปลี่ยนโทเค็น",
      from: "จาก",
      to: "ถึง",
      rate: "อัตรา: 1 GHOSTART = $0.000009 USDT",
      tradeOnPUF: "ซื้อขายในตลาด PUF",
      tradingInfo: "ข้อมูลการซื้อขาย",
      availablePairs: "คู่ที่พร้อมใช้งาน",
      priceInfo: "ข้อมูลราคา",
      currentRate: "อัตราปัจจุบัน",
      volume24h: "ปริมาณ 24 ชั่วโมง",
      liquidity: "สภาพคล่อง",
      tradeOnPUFTitle: "ซื้อขายใน PUF",
      tradeOnPUFDesc: "สำหรับประสบการณ์การซื้อขายที่ดีที่สุดและราคาแบบเรียลไทม์ ใช้ตลาด PUF โดยตรง",
      backToHome: "กลับหน้าแรก",
      active: "ใช้งานอยู่",
    },
    claim: {
      title: "รับ NFT ฟรี",
      description: "รับ NFT ฟรีของ GHOSTART - ไม่ต้องเสียค่าใช้จ่าย!",
      freeNFTTitle: "NFT ฟรีพร้อมใช้งาน",
      freeNFTDesc: "รับ NFT เอกสิทธิ์ของ GHOSTART ฟรีทั้งหมด! จำกัด 1 NFT ต่อกระเป๋าเงิน",
      freeMintingTitle: "การสร้าง 100% ฟรี",
      freeMintingDesc: "ไม่มีค่าธรรมเนียมแก๊ส ไม่ต้องจ่ายเงิน",
      onePerWalletTitle: "หนึ่งต่อกระเป๋าเงิน",
      onePerWalletDesc: "จำกัดเพื่อป้องกันสแปมและรับประกันความยุติธรรม",
      earlyAccessTitle: "ประโยชน์การเข้าถึงก่อน",
      earlyAccessDesc: "รับสิทธิ์เข้าถึงก่อนสำหรับการดรอปและฟีเจอร์ในอนาคต",
      claimNFT: "รับ NFT ฟรีของคุณ",
      connectWallet: "เชื่อมต่อกระเป๋าเงิน World App ของคุณ",
      verifyIdentity: "ยืนยันตัวตนของคุณ (ครั้งเดียว)",
      claimFree: "รับ NFT ฟรีของคุณ",
      estimatedTime: "เวลาที่คาดการณ์: 30 วินาที",
      agreeTerms: "เมื่อรับ คุณยอมรับข้อกำหนดและเงื่อนไขของเรา",
      collectionInfo: "ข้อมูลคอลเลกชัน NFT",
      collectionDetails: "รายละเอียดคอลเลกชัน",
      totalSupply: "อุปทานทั้งหมด",
      freeClaims: "การรับฟรี",
      remaining: "ที่เหลือ",
      nftBenefits: "ประโยชน์ของ NFT",
      earlyAccess: "การเข้าถึงก่อน",
      priorityDrops: "ความสำคัญสำหรับการดรอปในอนาคต",
      communityAccess: "การเข้าถึงชุมชน",
      joinDiscord: "เข้าร่วม Discord เอกสิทธิ์",
      futureRewards: "รางวัลในอนาคต",
      earnTokens: "รับโทเค็น $GHOSTART",
      viewCollection: "ดูคอลเลกชัน",
      viewCollectionDesc: "ดูคอลเลกชัน NFT GHOSTART เต็มรูปแบบและดูว่า NFT อื่นๆ มีอะไรบ้าง",
      tradeTokens: "แลกเปลี่ยนโทเค็น",
      backToHome: "กลับหน้าแรก",
  ...
  ja: {
    ...
    swap: {
      title: "トークンスワップ",
      description: "WLDと$GHOSTARTトークン間のスワップ",
      liveTradingTitle: "ライブ取引利用可能",
      liveTradingDesc: "PUFマーケットプレイスでリアルタイム価格と流動性で$GHOSTARTトークンを取引",
      instantSwapsTitle: "インスタントスワップ",
      instantSwapsDesc: "競争力のあるレートでトークンを即座にスワップ",
      secureTradingTitle: "セキュア取引",
      secureTradingDesc: "すべてのスワップはスマートコントラクトで保護されています",
      swapTokens: "トークンスワップ",
      from: "から",
      to: "へ",
      rate: "レート: 1 GHOSTART = $0.000009 USDT",
      tradeOnPUF: "PUFマーケットプレイスで取引",
      tradingInfo: "取引情報",
      availablePairs: "利用可能なペア",
      priceInfo: "価格情報",
      currentRate: "現在のレート",
      volume24h: "24時間ボリューム",
      liquidity: "流動性",
      tradeOnPUFTitle: "PUFで取引",
      tradeOnPUFDesc: "最高の取引体験とリアルタイム価格のために、PUFマーケットプレイスを直接使用してください",
      backToHome: "ホームに戻る",
      active: "アクティブ",
    },
    claim: {
      title: "無料NFTクレーム",
      description: "無料のGHOSTART NFTをクレーム - 費用不要！",
      freeNFTTitle: "無料NFT利用可能",
      freeNFTDesc: "完全無料で独占的なGHOSTART NFTをクレーム！ウォレットあたり1 NFTに制限",
      freeMintingTitle: "100%無料ミンティング",
      freeMintingDesc: "ガス料金なし、支払い不要",
      onePerWalletTitle: "ウォレットあたり1つ",
      onePerWalletDesc: "スパム防止と公平性確保のため制限",
      earlyAccessTitle: "早期アクセス特典",
      earlyAccessDesc: "将来のドロップと機能への優先アクセスを取得",
      claimNFT: "無料NFTをクレーム",
      connectWallet: "World Appウォレットを接続",
      verifyIdentity: "身元を確認（1回のみ）",
      claimFree: "無料NFTをクレーム",
      estimatedTime: "推定時間: 30秒",
      agreeTerms: "クレームすることで、利用規約に同意したことになります",
      collectionInfo: "NFTコレクション情報",
      collectionDetails: "コレクション詳細",
      totalSupply: "総供給量",
      freeClaims: "無料クレーム",
      remaining: "残り",
      nftBenefits: "NFT特典",
      earlyAccess: "早期アクセス",
      priorityDrops: "将来のドロップの優先権",
      communityAccess: "コミュニティアクセス",
      joinDiscord: "独占Discordに参加",
      futureRewards: "将来の報酬",
      earnTokens: "$GHOSTARTトークンを獲得",
      viewCollection: "コレクションを見る",
      viewCollectionDesc: "完全なGHOSTART NFTコレクションを確認し、他のNFTが利用可能かどうかを確認してください",
      tradeTokens: "トークン取引",
      backToHome: "ホームに戻る",
      limitedTime: "限定時間",
    },
  ...
  ko: {
    ...
    swap: {
      title: "토큰 스왑",
      description: "WLD와 $GHOSTART 토큰 간 스왑",
      liveTradingTitle: "라이브 거래 이용 가능",
      liveTradingDesc: "PUF 마켓플레이스에서 실시간 가격과 유동성으로 $GHOSTART 토큰 거래",
      instantSwapsTitle: "즉시 스왑",
      instantSwapsDesc: "경쟁력 있는 요율로 토큰을 즉시 스왑",
      secureTradingTitle: "보안 거래",
      secureTradingDesc: "모든 스왑은 스마트 계약으로 보호됩니다",
      swapTokens: "토큰 스왑",
      from: "에서",
      to: "로",
      rate: "요율: 1 GHOSTART = $0.000009 USDT",
      tradeOnPUF: "PUF 마켓플레이스에서 거래",
      tradingInfo: "거래 정보",
      availablePairs: "사용 가능한 페어",
      priceInfo: "가격 정보",
      currentRate: "현재 요율",
      volume24h: "24시간 거래량",
      liquidity: "유동성",
      tradeOnPUFTitle: "PUF에서 거래",
      tradeOnPUFDesc: "최고의 거래 경험과 실시간 가격을 위해 PUF 마켓플레이스를 직접 사용하세요",
      backToHome: "홈으로 돌아가기",
      active: "활성",
    },
    claim: {
      title: "무료 NFT 클레임",
      description: "무료 GHOSTART NFT 클레임 - 비용 없음!",
      freeNFTTitle: "무료 NFT 이용 가능",
      freeNFTDesc: "완전 무료로 독점적인 GHOSTART NFT를 클레임하세요! 지갑당 1 NFT로 제한",
      freeMintingTitle: "100% 무료 민팅",
      freeMintingDesc: "가스 수수료 없음, 결제 불필요",
      onePerWalletTitle: "지갑당 하나",
      onePerWalletDesc: "스팸 방지와 공정성 보장을 위해 제한",
      earlyAccessTitle: "조기 액세스 혜택",
      earlyAccessDesc: "향후 드롭과 기능에 대한 우선 액세스 획득",
      claimNFT: "무료 NFT 클레임",
      connectWallet: "World App 지갑 연결",
      verifyIdentity: "신원 확인 (한 번만)",
      claimFree: "무료 NFT 클레임",
      estimatedTime: "예상 시간: 30초",
      agreeTerms: "클레임함으로써 이용약관에 동의합니다",
      collectionInfo: "NFT 컬렉션 정보",
      collectionDetails: "컬렉션 세부사항",
      totalSupply: "총 공급량",
      freeClaims: "무료 클레임",
      remaining: "남은 수량",
      nftBenefits: "NFT 혜택",
      earlyAccess: "조기 액세스",
      priorityDrops: "향후 드롭 우선권",
      communityAccess: "커뮤니티 액세스",
      joinDiscord: "독점 Discord 참여",
      futureRewards: "향후 보상",
      earnTokens: "$GHOSTART 토큰 획득",
      viewCollection: "컬렉션 보기",
      viewCollectionDesc: "전체 GHOSTART NFT 컬렉션을 확인하고 다른 NFT가 사용 가능한지 확인하세요",
      tradeTokens: "토큰 거래",
      backToHome: "홈으로 돌아가기",
      limitedTime: "제한 시간",
    },
  ...
  pt: {
    ...
    swap: {
      ...
      description: "Troca entre tokens WLD e $GHOSTART",
      liveTradingTitle: "Negociação ao Vivo Disponível",
      liveTradingDesc: "Negocie tokens $GHOSTART no mercado PUF com preços e liquidez em tempo real",
      instantSwapsTitle: "Trocas Instantâneas",
      instantSwapsDesc: "Troque tokens instantaneamente com taxas competitivas",
      secureTradingTitle: "Negociação Segura",
      secureTradingDesc: "Todas as trocas são protegidas por contratos inteligentes",
      swapTokens: "Trocar Tokens",
      from: "De",
      to: "Para",
      rate: "Taxa: 1 GHOSTART = $0.000009 USDT",
      tradeOnPUF: "Negociar no Mercado PUF",
      ...
      liquidity: "Liquidez",
      tradeOnPUFTitle: "Negociar no PUF",
      tradeOnPUFDesc: "Para a melhor experiência de negociação e preços em tempo real, use o mercado PUF diretamente",
      backToHome: "Voltar ao Início",
      active: "Ativo",
    },
    claim: {
      title: "Reivindicação de NFT Gratuito",
      description: "Reivindique seu NFT gratuito do GHOSTART - Sem custo!",
      freeNFTTitle: "NFT Gratuito Disponível",
      freeNFTDesc: "Reivindique seu NFT exclusivo do GHOSTART completamente gratuito! Limitado a 1 NFT por carteira",
      freeMintingTitle: "Minting 100% Gratuito",
      freeMintingDesc: "Sem taxas de gas, sem pagamento necessário",
      onePerWalletTitle: "Um Por Carteira",
      onePerWalletDesc: "Limitado para prevenir spam e garantir justiça",
      earlyAccessTitle: "Benefícios de Acesso Antecipado",
      earlyAccessDesc: "Obtenha acesso prioritário a futuros drops e recursos",
      claimNFT: "Reivindicar Seu NFT Gratuito",
      connectWallet: "Conecte sua carteira World App",
      verifyIdentity: "Verifique sua identidade (uma vez)",
      claimFree: "Reivindique seu NFT gratuito",
      estimatedTime: "Tempo estimado: 30 segundos",
      agreeTerms: "Ao reivindicar, você concorda com nossos termos e condições",
      collectionInfo: "Informações da Coleção NFT",
      collectionDetails: "Detalhes da Coleção",
      totalSupply: "Fornecimento Total",
      freeClaims: "Reivindicações Gratuitas",
      remaining: "Restantes",
      nftBenefits: "Benefícios do NFT",
      earlyAccess: "Acesso Antecipado",
      priorityDrops: "Prioridade para futuros drops",
      communityAccess: "Acesso à Comunidade",
      joinDiscord: "Junte-se ao Discord exclusivo",
      futureRewards: "Recompensas Futuras",
      earnTokens: "Ganhe tokens $GHOSTART",
      viewCollection: "Ver Coleção",
      viewCollectionDesc: "Confira a coleção completa de NFTs GHOSTART e veja quais outros NFTs estão disponíveis",
      tradeTokens: "Negociar Tokens",
      backToHome: "Voltar ao Início",
